using ce205_hw3_gui.RedBlack_Tree;
using System;
...
namespace ce205_hw3_gui
{
    public partial class Form1 : Form
    {
        ...
        {
            tree.root = tree.InsertHelper(tree.root, Convert.ToString(valueBox1.Text));
            tree.inOrderHelper();
        }

        private void Delete_Click(object sender, EventArgs e)
        {
            tree.root = tree.deleteNode(tree.root, Convert.ToString(valueBox1.Text));
            tree.inOrderHelper();
        }

        private void Search_Click(object sender, EventArgs e)
        {
            tree.find(Convert.ToString(valueBox1.Text));
        }
        ...
        private void InsertRB_Click(object sender, EventArgs e)
        {
            rb.insertion(ref rb.root, Convert.ToString(valueBox2.Text.ToString()), this.Width / 2, 50);
            valueBox2.Text = "";
        }

        private void DeleteRB_Click(object sender, EventArgs e)
        {
            rb.delete(ref rb.root, Convert.ToString(valueBox2.Text.ToString()));
        }

        private void SearchRB_Click(object sender, EventArgs e)
        {
            rb.search(ref rb.root, Convert.ToString(valueBox2.Text.ToString()));
        }
        ...
        private void RandomRB_Click(object sender, EventArgs e)
        {
            ...
            valueBox2.Text = arrkeys[rand_num];
        }
        ...
        private void pictureBox1_Paint(object sender, PaintEventArgs e)
        {
            ...
            {
                e.Graphics.FillEllipse(item.brush, item.x, item.y, 80, 40);
